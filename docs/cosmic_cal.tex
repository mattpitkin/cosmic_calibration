...
that we can use from having a coincident GRB is that the system must be close to face-on, which 
allows us to place prior constraints on the system inclination angle. In our analysis we take two 
scenarios: the first use a 
