...
of XXX-XXX Mpc$^{-3}$yr$^{-1}$, or \ac{NSBH} merger rates. The ranges of rates for \acp{BNS} 
is obtained from population synthesis models together with knowledge of the X known \ac{BNS} systems 
in our galaxy, whilst the range for \acp{NSBH} is entirely from population synthesis as not such 
...
year~\cite{2013arXiv1304.0670L,2010CQGra..27q3001A}~\footnote{We should
