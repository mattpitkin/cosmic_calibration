...
For all our signals, for both simulation and recovery, we use the TaylorF2 waveform approximation (see e.g.~\cite{2009PhRvD..80h4043B}
...
\scft values recovered within given posterior credible intervals (see e.g.\ \cite{2014PhRvD..89h4060S})
...
that for sources at 50\,Mpc there is not a very significant bias on the recovery of \scft for any of
...
to generate the \scf values, but is instead far broader and more conservative. So, this bias is
...
\end{tabular}
\end{center}
\caption{\label{fig:ppplots} Each figure shows the cumulative fraction of true \scft values
found within a
